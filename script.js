...
function tellMe(joke){
    VoiceRSS.speech({
        key: 'f8487c43ac2b4aa8a3b82c5bd948e67a',
        src: joke,
        hl: 'en-us',
        r: 0,
        c: 'mp3',
...
async function getJokes(){
    let joke = '';
    const apiUrl = 'https://v2.jokeapi.dev/joke/Programming,Pun,Spooky?blacklistFlags=nsfw,religious,political,racist,sexist,explicit';
    try {
...
//Event Listener berguna buat button.
